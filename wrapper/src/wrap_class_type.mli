...
val wrap : Ident.t -> Types.class_type_declaration -> JavaAST.class_ * JavaAST.class_
(** Returns the classes wrapping the class type whose name and definition are passed. *)
