...
let environment = ref Env.initial

let update_environment_with_signature signature =
  environment := Env.add_signature signature !environment

let java_class = ref None
