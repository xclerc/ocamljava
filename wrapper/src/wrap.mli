...
val file : string -> string option -> unit
(** [file cmi_filename package_name] wrap the cmi file whose path
    [cmi_filename], using [package_name] as the package for the generated
    class. *)
