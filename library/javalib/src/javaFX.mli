...
(** Shorthand for the type of JavaFX applications. *)

type stage = javafx'stage'Stage java_instance
(** Shorthand for the type of JavaFX stages. *)

module type Application = sig
  val init : application -> unit
  (** The implementation of the {java javafx.application.Application#init()} method. *)
  val start : application -> stage -> unit
  (** The implementation of the {java javafx.application.Application#start(javafx.stage.Stage)} method. *)
  val stop : application -> unit
  (** The implementation of the {java javafx.application.Application#stop()} method. *)
end
(** The module type for applications linked with {k -javafx-application}. *)
