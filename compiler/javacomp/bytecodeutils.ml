...
let meth_make_proxy = JAVA_INVOKE_STATIC "org.ocamljava.runtime.primitives.javalibs.javabase.Java.ocamljava_java_make_proxy(Class[],Value,org.ocamljava.runtime.primitives.javalibs.javabase.MethodMapping):Object"
